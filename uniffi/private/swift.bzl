...
load("@build_bazel_rules_swift//swift:providers.bzl", "SwiftCompilerPluginInfo", "SwiftInfo")
...
load("@build_bazel_rules_swift//swift/internal:attrs.bzl", "swift_deps_attr")
load(
...
load("@build_bazel_rules_swift//swift/internal:linking.bzl", "new_objc_provider")
load(
...
load("@build_bazel_rules_swift//swift/internal:toolchain_utils.bzl", "use_swift_toolchain")
load(
...
""",
    fragments = ["cpp"],
    implementation = swift_library_impl,
    toolchains = use_swift_toolchain(),
)

def swift_interop_hint_impl(ctx):
